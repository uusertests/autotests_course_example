...
def repeats(our_str):
    new_str = ""  # Переменная для хранения новой строки с символами и их количеством повторений
    for i, char in enumerate(our_str):  # Проходим по каждому символу в строке our_str с помощью цикла
