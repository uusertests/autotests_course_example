...
def to_roman(val):
    ...
    roman_str = ""  # Переменная для хранения римского числа
    for num, roman in roman_dict.items():
        while val >= num:  # Пока значение числа больше или равно текущей римской цифры
            roman_str += roman  # Добавляем римскую цифру в строку
            val -= num  # Вычитаем значение числа, соответствующее римской цифре
    return roman_str
