...
def letter_stat(our_str):
    letters_dict = {}  # Создаем пустой словарь для хранения статистики букв
    for letter in our_str:  # Проходим по каждой букве в строке
        if letter in letters_dict:  # Если буква уже присутствует в словаре
            letters_dict[letter] += 1  # Увеличиваем счетчик для данной буквы на 1
        else:
            letters_dict[letter] = 1  # Иначе, добавляем букву в словарь и устанавливаем счетчик на 1
    return letters_dict  # Возвращаем словарь с результатом подсчета статистики букв
