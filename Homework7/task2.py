...
class PersonInfo:
    ...
    def short_name(self):
        ...
        # Формирование краткого имени
        short_name = last_name + ' ' + first_name[0] + '.'
        return short_name

    def path_deps(self):
        # Формирование пути подразделений с использованием стрелок
    ...
    def new_salary(self):
        ...
        # Вычисление суммарного количества трех наиболее часто встречающихся букв
